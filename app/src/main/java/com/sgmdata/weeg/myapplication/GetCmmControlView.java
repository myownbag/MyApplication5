...
import com.sgmdata.weeg.myapplication.DataTypeCollect.CommControldataBean;
...
public class GetCmmControlView extends BasePager {
    View view = null;
    ...
    public ArrayList<CommControldataBean> mydata;
    public listviewadpater myadpater;

    public GetCmmControlView(Activity activity) {
        super(activity);
        mActivity=activity;
        initViews();
        initdata();
    ...
    private void accesshttppost() {
        ...
        String url = "http://112.21.191.16:8000/SGMPServices/SgmpInfoInterface.asmx/GetSGMPControlCmdData?userid=root&userpasswd=weeg@20080725&sgmpserial=%s";
...
//                Log.d("zl","1"+temp.chunnelserial+temp.devserial);
    ...
    {
        CommControldataBean actimeCommData=null;
        int event=-1;
        ...
        while (event!= XmlPullParser.END_DOCUMENT) {
            switch (event) {
                ...
                case XmlPullParser.START_TAG:
                    ...
                    if("sgmp_controlcmd".equals(elementName))
                    {
                        actimeCommData=new CommControldataBean();
                    }
                    break;
