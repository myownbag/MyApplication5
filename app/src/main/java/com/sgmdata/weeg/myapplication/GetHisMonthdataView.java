...
//            Log.d("zl","on adpater" + mydata.get(0).Mondata.get(i).get("label")+"--"+mydata.get(0).Mondata.get(i).get("detail"));
    ...
    private void accesshttppost() {
        ...
        String url = "http://112.21.191.16:8000/SGMPServices/SgmpInfoInterface.asmx/GetSGMPHisMonthData?userid=root&userpasswd=weeg@20080725&sgmpserial=%s&month=%s";
        ...
        while (event!= XmlPullParser.END_DOCUMENT) {
            switch (event) {
                ...
                case XmlPullParser.START_TAG:
                    ...
                    if("sgmp_his_data".equals(elementName))
                    {
